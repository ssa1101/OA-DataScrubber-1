...
from flask import Flask, send_from_directory, Request, render_template, url_for, redirect
...
class UsersModel(db.Model):
    ...
    dob = db.Column(db.DateTime, server_default=func.now(), nullable=False)
...
user1 = UsersModel(firstName="Shifa", lastName="Sadaat", dob=date(2022, 12, 25),
                   age=19, email="Shifa@example.com")
user2 = UsersModel(firstName="John", lastName="Doe", dob=date(2022, 12, 25),
